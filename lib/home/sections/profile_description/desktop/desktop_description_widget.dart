...
class DesktopDescriptionWidget extends StatelessWidget {
  const DesktopDescriptionWidget({super.key});
          ...
          child: Column(
            ...
            children: [
              RoundedText(
                ...
                color: ThemeConstants.flatBackgroundColor,
                textColor: ThemeConstants.terciaryTextColor,
              ),
              SizedBox(height: 20),
              TitleText(),
              SizedBox(height: 20),
